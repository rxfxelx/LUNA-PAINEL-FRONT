...
async function openChat(ch){
  ...
  // comportamento mobile: mostrar somente mensagens
...
document.addEventListener("DOMContentLoaded", () => {
  // ordem dos scripts no HTML deve ser: config.js -> app.js
  ...
  $("#btn-back-mobile")?.addEventListener("click", showChatListMobile);
